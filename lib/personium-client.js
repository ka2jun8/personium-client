...
const utility_1 = __webpack_require__(8);
class PersoniumClient {
    ...
    getExtCellLisks(cell, targetCellUrl, type, _token) {
        return new Promise((resolve, reject) => {
            const token = _token || this.token;
            const url = this.createCellSchema(cell) + "__ctl/ExtCell('" + utility_1.toEscapeSequence(targetCellUrl) + "')/\$links/" + type;
            request
                .get(url)
                .set("Accept", "application/json")
                .set("Authorization", "Bearer " + token)
...
exports.toEscapeSequence = (original) => {
